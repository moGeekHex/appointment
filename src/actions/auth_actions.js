...
const finishLogin = async (dispatch,token) => {
    ...
    try{
        ...
        // console.log(user)
        // const user.displayName = await firebase.auth().signInAndRetrieveDataWithCredential(credential);
        // const user.photoURL = await firebase.auth().signInAndRetrieveDataWithCredential(credential);
        // const user.uid = await firebase.auth().signInAndRetrieveDataWithCredential(credential);
